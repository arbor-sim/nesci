...
#define NESCI_TESTING_TRIPLET(type, name, value0, value1, value2, invalid) \
  static const type ANY_##name{value0};                                    \
  static const type ANOTHER_##name{value1};                                \
  static const type THIRD_##name{value2};                                  \
  static const type NO_##name { invalid }
#define NESCI_TESTING_TRIPLET_VECTOR(type, name, value0, value1, value2, \
                                     invalid)                            \
  static const std::vector<type> ANY_##name##S{value0, value1, value2};  \
...
#define NESCI_TESTING_TRIPLET_VECTOR_STRING(name, value0, value1, value2)      \
  static const std::vector<std::string> ANY_##name##S{value0, value1, value2}; \
  NESCI_TESTING_TRIPLET(char*, name, value0, value1, value2, "NO ##name")
#define NESCI_TESTING_TRIPLET_VECTOR_STRINGIFIED(name)                         \
  static const std::vector<std::string> ANY_##name##S_STRING{                  \
